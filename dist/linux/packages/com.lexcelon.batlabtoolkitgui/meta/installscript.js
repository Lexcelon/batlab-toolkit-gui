function Component() {
    ...
    component.addElevatedOperation("Execute", "cp", "/etc/shells", "@TargetDir@/Batlab-run", "UNDOEXECUTE", "rm", "@TargetDir@/Batlab-run");
    ...
    component.addElevatedOperation("Execute", "ln", "-sf", "@TargetDir@/Batlab-run", "/usr/local/bin/batlab-toolkit-gui", "UNDOEXECUTE", "rm", "/usr/local/bin/batlab-toolkit-gui");

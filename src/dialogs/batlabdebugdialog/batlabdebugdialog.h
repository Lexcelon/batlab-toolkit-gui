...
public:
    explicit BatlabDebugDialog(QWidget *parent = nullptr, QVector<batlabStatusInfo> infos = QVector<batlabStatusInfo>(), QVector<QString> firmwareVersions = QVector<QString>());
    ~BatlabDebugDialog();
